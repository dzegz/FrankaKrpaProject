...
class KinectStreamIterator:
    def __init__(self):
        ...
        self.color_sub = FrameSubscriber(client, "kinect_rgb", self.rec_color)
        self.depth_sub = FrameSubscriber(client, "kinect_depth", self.rec_depth)

        print("KinectStreamIterator created")
